...
test ('bezierCurve2 flat line', () => {
  ...
  expect(result[0]).toEqual(VectorN.from(10.0, 10.0))
  expect(result[1]).toEqual(VectorN.from(10.5, 10.5))
  expect(result[2]).toEqual(VectorN.from(11.0, 11.0))
})
...
test ('bezierCurve3 square edge', () => {
  ...
  expect(result[2]).toEqual(VectorN.from(1.0, 1.0))
})
...
test ('bezierSurface3 square edge', () => {
